"""
HTTP health and metrics server for the email-notifier service.
...
class HealthServer:
    ...
    Args:
        ...
        port:    TCP port to listen on (default 8084).
    """
    ...
    async def _handle_health(self, request: web.Request) -> web.Response:
        ...
        payload: dict[str, Any] = {
            ...
            "emails_sent": _counter_value(self._metrics.emails_sent_total),
            "email_errors": _counter_value(self._metrics.email_errors_total),
        }
